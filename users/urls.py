...
# ecommerce/urls.py path("exams/", views.exam_list_view, name="exam_list"),
    path("exams/<int:pk>/", views.exam_detail_view, name="exam_detail"),
    path("exams/<int:pk>/results/", views.exam_results_view, name="exam_results"),
    path("google-form/<int:exam_id>/", views.google_form, name="google_form"),
    path("sync-all/", views.sync_all_results_view, name="sync_all"),
    path("sync-job/", views.sync_job_trigger_view, name="sync_job"),
        path("admin/results/", views.google_results_list, name="google_results_list"),
